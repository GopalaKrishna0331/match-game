...
class MatchGame extends Component {
  ...
  matchGameTabContainer = () => {
    const {image, TabId} = this.state
        ...
        <ul className="image-container">
          {newList.map(each => (
            <MatchImage
              each={each}
              key={each.id}
              matchTagElement={this.matchTagElement}
            />
          ))}
        </ul>
      </div>
      ...
      <div className="result-container">
        ...
        >
          <img
            ...
            className="reset"
          />
          <p className="result-span">PLAY AGAIN</p>
        </button>
      </div>
    )
  }
        ...
        <nav className="nav-container">
          ...
          <ul className="nav-list-items">
            ...
            <li className="list-items">
              ...
              />
              <p className="count">{timer < 10 ? `0${timer}` : timer} sec</p>
            </li>
          </ul>
        </nav>
        <div className="tab-container">
          {status ? this.resulTabContainer() : this.matchGameTabContainer()}
        </div>
      </>
    )
  }
